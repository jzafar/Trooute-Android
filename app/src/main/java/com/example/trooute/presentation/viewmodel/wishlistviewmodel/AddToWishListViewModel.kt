...
class AddToWishListViewModel @Inject constructor(
    ...
    private val _addToWishListState = MutableStateFlow<Resource<BaseResponse>>(Resource.LOADING)
    val addToWishListState: StateFlow<Resource<BaseResponse>> get() = _addToWishListState
